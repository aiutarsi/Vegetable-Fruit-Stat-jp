...
downloadGraph.addEventListener('click', function(event) {
  ...
  if (svgPrinted !== null) { /* 存在する場合のみ */
    ...
    let fileName = foodInput.value + "_" + startYearInput.value + "-" + startMonthInput.value + "-" + startDayInput.value + "_" + endYearInput.value + "-" + endMonthInput.value + "-" + endDayInput.value + ".png";
